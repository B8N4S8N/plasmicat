...
import Price from "../../Price"; // plasmic-import: nxbJNa_1gtQC8o/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic_commerce_landing_page.module.css"; // plasmic-import: vyozepJ6xip7aaU4b7VPCN/projectcss
import sty from "./PlasmicProductCard.module.css"; // plasmic-import: qer-BTKJtG4iMx/css
    ...
    >
      ...
      >
        ...
        {(
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__lp2US, {
              [sty.freeBoxsmall__lp2USnMc3]: hasVariant(
                variants,
                "small",
                "small"
              )
        ...
        {(hasVariant(variants, "small", "small") ? true : true) ? (
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox___41Mwz, {
              [sty.freeBoxsmall___41MwZnMc3]: hasVariant(
                variants,
                "small",
                "small"
              )
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__lp7M)}>
              {p.renderPlasmicSlot({
                defaultContents: (
              ...
              {p.renderPlasmicSlot({
                defaultContents: (
                  <Rating
                    className={classNames("__wab_instance", sty.rating__ywqe)}
                  />
                ),
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__rXptX)}
            >
              {p.renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>

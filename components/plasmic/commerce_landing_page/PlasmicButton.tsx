...
import sty from "./PlasmicButton.module.css"; // plasmic-import: UBst1-0CrAf6xH/css
  ...
  return (
    ...
    >
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__iujv8, {
            [sty.freeBoxiconOnly__iujv8NlNny]: hasVariant(
              variants,
              "iconOnly",
              "iconOnly"
            ),
            [sty.freeBoxshowEndIcon__iujv8HiLc3]: hasVariant(
              variants,
              "showEndIcon",
              "showEndIcon"
            ),
            [sty.freeBoxshowStartIcon__iujv8FffZ]: hasVariant(
              variants,
              "showStartIcon",
              "showStartIcon"
            ),
            [sty.freeBoxsize_large__iujv8PtKy3]: hasVariant(
              variants,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__iujv8SXurx]: hasVariant(
              variants,
              "size",
              "small"
            )
        ...
        >
          {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true)
            ? p.renderPlasmicSlot({
                defaultContents: (
                  <MenuIcon
                    className={classNames(projectcss.all, sty.svg__iQKtE)}
                    role={"img"}
                  />
                ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__enG6, {
            [sty.freeBoxshowEndIcon__enG6HiLc3]: hasVariant(
              variants,
              "showEndIcon",
              "showEndIcon"
            ),
            [sty.freeBoxsize_small__enG6SXurx]: hasVariant(
              variants,
              "size",
              "small"
            )
        ...
        >
          {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false)
            ? p.renderPlasmicSlot({
                defaultContents: (
                  <MenuIcon
                    className={classNames(projectcss.all, sty.svg__iuu7I)}
                    role={"img"}
                  />
                ),
